...
def main():
    ...
    print(f"  1. If index doesn't exist: Wait 2-3 minutes and run this again")
    print(f"  2. If critical errors: Check D:\\DocumentSearch\\logs\\errors.log")
    print(f"  3. Dashboard: http://localhost:8501")
    print(f"  4. OpenSearch: http://localhost:9200/_cat/indices?v")
    print()
