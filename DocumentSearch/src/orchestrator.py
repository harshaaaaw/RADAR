...
from core.constants import QueueStatus, SizeCategory, WorkerPoolType
...
class MasterOrchestrator:
    ...
    def _verify_services(self) -> bool:
        ...
        try:
            ...
            if result.returncode == 0:
                ...
                logger.error(f"  ✗ Tesseract: Command failed")
                services_ok = False
        except Exception as e:
    ...
    def _count_total_pending(self, queue_stats: Dict) -> int:
    ...
    def _restore_from_checkpoint(self, checkpoint: Dict):
        ...
        # Most state is already in the database
        # Just need to reset any files stuck in 'processing' state
        # (they were being processed when system shut down)
