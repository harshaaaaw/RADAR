...
class ConfigurationManager:
    ...
    def _load_environment_variables(self) -> None:
        ...
        self.raw_config['indexing']['opensearch']['username'] = opensearch_user
        self.raw_config['indexing']['opensearch']['password'] = opensearch_password
        ...
        self.raw_config['alerting']['email']['username'] = smtp_user
        self.raw_config['alerting']['email']['password'] = smtp_password
        ...
        self.raw_config['api']['api_token'] = api_token
    ...
    def _create_config_objects(self) -> None:
        ...
        # Create TesseractConfig
        tesseract = TesseractConfig(**self.raw_config['ocr']['tesseract'])
