            ...
            try:
                ...
                index_body = {
                    'settings': {
                        ...
                        'analysis': {
                            'char_filter': {
                                # Common OCR character misreads: 0/O, 1/l/I, 5/S, etc.
                                'ocr_char_fixes': {
                                    'type': 'mapping',
                                    'mappings': [
                                        '0 => o',  # zero to letter o (common OCR error)
                                        '1 => l',  # one to letter l
                            ...
                            'analyzer': {
                                ...
                                # OCR-specific analyzer with error correction
                                'ocr_analyzer': {
                                    'type': 'custom',
                                    'char_filter': ['ocr_char_fixes'],
                                    'tokenizer': 'standard',
                                    'filter': [
                                        'lowercase',
                                        'word_delimiter_filter',
