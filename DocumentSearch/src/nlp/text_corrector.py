...
class TextCorrector:
        ...
        try:
            ...
            if model_path:
                try:
                    ...
                    logger.debug(f"Could not load model: {model_path}, trying fallbacks")
            ...
            logger.warning("SpaCy not installed, using rule-based corrections only")
            return False
    ...
    def _build_ocr_char_fixes(self) -> Dict[str, str]:
        ...
        return {
            ...
            '|': 'I',
            'l': 'l',  # Keep as is, handled in context
