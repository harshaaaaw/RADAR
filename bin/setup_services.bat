...
REM Set paths (all derived from BIN_DIR - no external dependencies needed)
...
%NSSM% install Tika-9998 "%JAVA_HOME%\bin\java.exe" "-Xmx2g" "-Xms2g" "-Djava.io.tmpdir=%PROJECT_ROOT%\\runtime\\temp\\tika1" "-jar" "%TIKA_JAR%" "--host=localhost" "--port=9998"
...
%NSSM% set Tika-9998 AppStdout "%PROJECT_ROOT%\\runtime\\logs\\tika\\tika-9998-service.log"
%NSSM% set Tika-9998 AppStderr "%PROJECT_ROOT%\\runtime\\logs\\tika\\tika-9998-service-error.log"
...
%NSSM% install Tika-9999 "%JAVA_HOME%\bin\java.exe" "-Xmx2g" "-Xms2g" "-Djava.io.tmpdir=%PROJECT_ROOT%\\runtime\\temp\\tika2" "-jar" "%TIKA_JAR%" "--host=localhost" "--port=9999"
...
%NSSM% set Tika-9999 AppStdout "%PROJECT_ROOT%\\runtime\\logs\\tika\\tika-9999-service.log"
%NSSM% set Tika-9999 AppStderr "%PROJECT_ROOT%\\runtime\\logs\\tika\\tika-9999-service-error.log"
...
%NSSM% install Tika-10000 "%JAVA_HOME%\bin\java.exe" "-Xmx2g" "-Xms2g" "-Djava.io.tmpdir=%PROJECT_ROOT%\\runtime\\temp\\tika3" "-jar" "%TIKA_JAR%" "--host=localhost" "--port=10000"
...
%NSSM% set Tika-10000 AppStdout "%PROJECT_ROOT%\\runtime\\logs\\tika\\tika-10000-service.log"
%NSSM% set Tika-10000 AppStderr "%PROJECT_ROOT%\\runtime\\logs\\tika\\tika-10000-service-error.log"
...
%NSSM% install Tika-10001 "%JAVA_HOME%\bin\java.exe" "-Xmx2g" "-Xms2g" "-Djava.io.tmpdir=%PROJECT_ROOT%\\runtime\\temp\\tika4" "-jar" "%TIKA_JAR%" "--host=localhost" "--port=10001"
...
%NSSM% set Tika-10001 AppStdout "%PROJECT_ROOT%\\runtime\\logs\\tika\\tika-10001-service.log"
%NSSM% set Tika-10001 AppStderr "%PROJECT_ROOT%\\runtime\\logs\\tika\\tika-10001-service-error.log"
...
%NSSM% install Tika-10002 "%JAVA_HOME%\bin\java.exe" "-Xmx2g" "-Xms2g" "-Djava.io.tmpdir=%PROJECT_ROOT%\\runtime\\temp\\tika5" "-jar" "%TIKA_JAR%" "--host=localhost" "--port=10002"
...
%NSSM% set Tika-10002 AppStdout "%PROJECT_ROOT%\\runtime\\logs\\tika\\tika-10002-service.log"
%NSSM% set Tika-10002 AppStderr "%PROJECT_ROOT%\\runtime\\logs\\tika\\tika-10002-service-error.log"
...
%NSSM% install Tika-10003 "%JAVA_HOME%\bin\java.exe" "-Xmx2g" "-Xms2g" "-Djava.io.tmpdir=%PROJECT_ROOT%\\runtime\\temp\\tika6" "-jar" "%TIKA_JAR%" "--host=localhost" "--port=10003"
...
%NSSM% set Tika-10003 AppStdout "%PROJECT_ROOT%\\runtime\\logs\\tika\\tika-10003-service.log"
%NSSM% set Tika-10003 AppStderr "%PROJECT_ROOT%\\runtime\\logs\\tika\\tika-10003-service-error.log"
...
%NSSM% install Tika-10004 "%JAVA_HOME%\bin\java.exe" "-Xmx2g" "-Xms2g" "-Djava.io.tmpdir=%PROJECT_ROOT%\\runtime\\temp\\tika7" "-jar" "%TIKA_JAR%" "--host=localhost" "--port=10004"
...
%NSSM% set Tika-10004 AppStdout "%PROJECT_ROOT%\\runtime\\logs\\tika\\tika-10004-service.log"
%NSSM% set Tika-10004 AppStderr "%PROJECT_ROOT%\\runtime\\logs\\tika\\tika-10004-service-error.log"
...
%NSSM% install Tika-10005 "%JAVA_HOME%\bin\java.exe" "-Xmx2g" "-Xms2g" "-Djava.io.tmpdir=%PROJECT_ROOT%\\runtime\\temp\\tika8" "-jar" "%TIKA_JAR%" "--host=localhost" "--port=10005"
...
%NSSM% set Tika-10005 AppStdout "%PROJECT_ROOT%\\runtime\\logs\\tika\\tika-10005-service.log"
%NSSM% set Tika-10005 AppStderr "%PROJECT_ROOT%\\runtime\\logs\\tika\\tika-10005-service-error.log"
