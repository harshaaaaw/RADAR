...
try {
    ...
    Write-Host "  cd C:\Users\DELL\Downloads\opensearch-2.14.0-windows-x64\opensearch-2.14.0\bin" -ForegroundColor Yellow
...
try {
    ...
    Write-Host "  cd C:\Users\DELL\Downloads\DocumentSearch\DocumentSearch\bin" -ForegroundColor Cyan
...
if (Test-Path "C:\DocumentSearch\queue\queue.db") {
